  ...
  head: () => ({
    meta: [
      ...
      { title: "Nova Suite — Tools that ship" },
      {
        name: "description",
        content:
          "Nova Suite is a family of open-source tools — NovaPad, Lumia, NovaFinder, NovaGitX and Cirrus — built for people who care about the details.",
      },
      ...
      { property: "og:title", content: "Nova Suite — Tools that ship" },
      {
        ...
        content:
          "A family of fast, native, open-source tools for the modern desktop and cloud.",
      },
          ...
          <div className="flex min-w-0 flex-1 flex-col">
            <header className="sticky top-0 z-20 flex h-14 items-center gap-3 border-b border-border bg-background/70 px-4 backdrop-blur-xl">
              ...
              <div className="flex items-center gap-2">
                <span className="font-display text-sm font-semibold tracking-tight">Nova Suite</span>
            ...
            <footer className="border-t border-border bg-background/60 px-6 py-6 text-xs text-muted-foreground backdrop-blur">
